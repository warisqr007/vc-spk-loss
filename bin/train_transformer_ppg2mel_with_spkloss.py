...
from src.data_load import VCTKDataset, MultiSpkVcCollate
...
class Solver(BaseSolver):
    ...
    def load_data(self):
        ...
        train_dataset = VCTKDataset(
            ...
            wav_dir = self.config.data.wav_dir,
            spk_dvec_dir = self.config.data.spk_dvec_dir,
        ...
        while self.step < self.max_step:
            for data in self.train_dataloader:
                ...
                ppgs, mels, in_lengths, \
                    out_lengths, _, _, lwav = self.fetch_data(data)
                self.timer.cnt("rd")

                spk_ids = self.compute_speaker_embedding(mels)
    ...
    def validate(self):
        ...
        for i, data in enumerate(self.dev_dataloader):
            ...
            ppgs, mels, in_lengths, \
                out_lengths, _, _, _ = self.fetch_data(data)
