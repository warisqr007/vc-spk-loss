...
def run(args):
    ...
    # Get file id list
    wav_file_list = glob2.glob(f"{wav_dir}/**/*mic2.wav")
...
def get_parser():
    ...
    parser.add_argument(
        "--output_dir",
        default='/mnt/data1/waris/model_preprocessing/transformer-vc-vctk/f0',
        type=str,
    )
    parser.add_argument(
        "--frame_period_ms",
...
def main():
    ...
    print(args)
    run(args)
    #process_one('/mnt/data1/waris/datasets/data/arctic_dataset/all_data_for_ac_vc_train/ASI/wav/arctic_a0562.wav', args, args.output_dir)
